...
export default function AutomationsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">
            Crie fluxos de trabalho que reagem a eventos do WhatsApp® de forma automática.
          </p>
        </div>
        <Button
      ...
      {showTemplates && (
        <section>
          <h2 className="mb-3 text-sm font-semibold text-slate-300">Modelos rápidos para começar</h2>
      ...
      <Dialog open={!!pendingDelete} onOpenChange={(v) => !v && setPendingDelete(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Isso excluirá permanentemente <span className="text-white">{pendingDelete?.name}</span> e todo o seu histórico de execuções. Esta ação não pode ser desfeita.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
