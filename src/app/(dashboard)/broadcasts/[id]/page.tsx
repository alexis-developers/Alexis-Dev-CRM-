...
export default function BroadcastDetailPage() {
  ...
  const funnelSteps: FunnelStep[] = [
    { label: 'Enviada', value: broadcast.sent_count, color: 'bg-violet-500' },
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-slate-800 hover:bg-transparent">
                  ...
                  <TableHead className="text-slate-400">Enviada</TableHead>
                  <TableHead className="text-slate-400">Entregue</TableHead>
                  <TableHead className="text-slate-400">Lida</TableHead>
