    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-slate-800 bg-slate-900/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        ...
        <Metric
          ...
          tooltip="Soma dos valores de todos os negócios neste funil, excluindo os marcados como Perdidos."
        />
        <Metric
          icon={<Target className="h-4 w-4 text-blue-400" />}
          label="Ticket Médio"
          value={formatCurrency(stats.avgValue)}
          tooltip="Valor do Funil dividido pelo Total de Negócios — o valor médio de um negócio ativo."
        />
        <Metric
          icon={<TrendingUp className="h-4 w-4 text-purple-400" />}
          label="Valor Ponderado"
          value={formatCurrency(stats.weightedValue)}
          tooltip="Receita prevista: o valor de cada negócio aberto × a probabilidade da sua etapa. Primeira etapa ≈ 10%, progredindo até 90%, Ganho = 100%. Negócios Perdidos são excluídos."
        />
        <Metric
